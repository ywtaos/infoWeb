...
listShare=function (pageIndex,heat) {
	...
	param.searchKeyword=$("#subjectTitle").val();
	if(heat==1){
		param.heat = 1;
	}
	CCore.invoke("share/getshares", param,function(data){		
		console.log(data);		
...
window['CSubjectSlist']['init']=init;
window['CSubjectSlist']['listShare']=listShare;
})();
