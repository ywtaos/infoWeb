...
/**
 * @author xutao
 * @version V1.0 创建时间：2017/11/20 22:24
 *          Copyright 2017 by 言午工作室
 */
public class DaoUtil {
    
    private static Log LOGGER = LogFactory.getLog(DaoUtil.class);
     ...
     * @return List
     */
    public static List<List> assemblingList(final Integer size, final Object... obj) throws RuntimeException {
        int length = obj.length;
        if (length % size != 0) {
            throw new RuntimeException("長度不一致");
        } else {
